export default {
  ...
  settings: {
    ...
    provider_auth: 'Аутентификация платформы',
    auth_logged_in: 'Вошёл: {name}',
    auth_not_logged_in: 'Не авторизован',
    auth_save: 'Сохранить',
    auth_browser_login: 'Вход через браузер',
    auth_clear: 'Очистить',
    auth_logging_in: 'Ожидание входа...',
    auth_login_success: 'Вход выполнен',
    auth_login_failed: 'Ошибка входа: {msg}',
    about: 'О программе',
    version: 'Версия',
